...
<html lang="en" >
    ...
    <%
        ...
        if (request.getParameter("del") != null) {
            ...
            String delQry = "delete from  tbl_rent where rent_id='" + request.getParameter("del") + "'";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        %>
                        Officer Accepted  & Waiting for Subadmin Verification
                        <%
                        ...
                        <a href="Property.jsp?del=<%=rs.getString("rent_id")%>"><img src="../Assets/remove.png"  width="25" height="25"></a>
                            <%
