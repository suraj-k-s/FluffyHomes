...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    String InsQry = "INSERT INTO tbl_user( user_name, user_contact,user_email,user_address,user_zipcode,user_gender,user_photo,user_proof,user_doj,place_id,user_password)"
