    ...
    <body>
        <%
            if(request.getParameter("txt_update")!=null){
              ...
              String selUser="select * from tbl_owner where owner_password='"+pass+"' and owner_id='"+session.getAttribute("oid")+"' ";
              ResultSet u1=cp.selectCommand(selUser);
              if(u1.next()){
                  if(Cpass.equals(Npass)){
                      String upd="Update tbl_owner set owner_password='"+Cpass+"' where owner_id='"+session.getAttribute("oid")+"' ";
