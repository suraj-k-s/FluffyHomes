...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Request Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_rentbook rb inner join tbl_rent u.rent_id=rb.rent_id inner join tbl_owner o on o.owner_id=u.owner_id where user_id='" + session.getAttribute("uid") + "'";
