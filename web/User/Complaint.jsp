    ...
    <body>
        <%
            if (request.getParameter("txt_save") != null) {
                String insqry = "insert into tbl_complaint(complaint_date,complaint_title,complaint_content,user_id)values(curdate(),'" + request.getParameter("txt_subject") + "','" + request.getParameter("txt_complaint") + "','" + session.getAttribute("uid") + "')";
