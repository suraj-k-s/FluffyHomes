            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        %>
                        Officer Accepted  | 
                        <a href="Property.jsp?id=<%=rs.getString("rent_id")%>&sts=3"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Property.jsp?id=<%=rs.getString("rent_id")%>&sts=4"><img src="../Assets/remove.png"  width="25" height="25"></a>
                            <%
