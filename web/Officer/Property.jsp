...
<html lang="en" >
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            String upQry = "update tbl_rent set rent_status='" + request.getParameter("sts") + "' where rent_id='" + request.getParameter("id") + "'";
    ...
    %>
    <body>
        <h1 align="center" id="heading">Property Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_rent r inner join tbl_place p on p.place_id=r.place_id inner join tbl_district d on d.district_id=p.district_id inner join tbl_state s on s.state_id=d.state_id inner join tbl_country c on c.country_id=s.country_id inner join tbl_renttype rt on rt.renttype_id=r.renttype_id inner join tbl_owner o on o.owner_id=r.owner_id where c.country_id='" + session.getAttribute("country") + "'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <%
                            ...
                            if (rs.getString("rent_status").equals("0")) {
                        %>
                        <a href="Property.jsp?id=<%=rs.getString("rent_id")%>&sts=1"><img src="../Assets/check.png" width="25" height="25"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="Property.jsp?id=<%=rs.getString("rent_id")%>&sts=2"><img src="../Assets/remove.png"  width="25" height="25"></a>
                            <%
                            } else if (rs.getString("rent_status").equals("1")) {
                            %>
                        Accepted and Waiting for Subadmin Verification

                        <%
                        } else if (rs.getString("rent_status").equals("2")) {
                        %>
                        Rejected
                        <%
                        } else if (rs.getString("rent_status").equals("3")) {
                        %>
                        Subadmin accepted | Property listed 
                        <%
                        } else if (rs.getString("rent_status").equals("4")) {
                        %>
                        Subadmin Rejected
                        <%
                            }
